...
type Notification = { id: string; type: string; cardId: string | null; feedbackId: string | null; payload: Record<string, string>; read: boolean; createdAt: string; actor: { publicId: string; name: string; avatar: string } | null };
...
function notificationText(item: Notification) {
  ...
  if (item.type === 'system_message') return item.payload.titleZh || '系统公告';
  if (item.type === 'feedback_reply') return '你的反馈收到回复';
