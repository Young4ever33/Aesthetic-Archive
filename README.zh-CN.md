...
> **Aesthetic Archive 是一个面向设计师的 AI 审美知识工作区，把分散的视觉参考转化为可搜索、可解释、可复用的设计智能。**
...
Aesthetic Archive 不把参考图当作单纯的图片，而是把它转化为结构化审美卡片，记录设计元素、文化语境、材料、光线、几何、字体、色彩、构图、使用场景、双语 Prompt、Negative Prompt、来源和版权信息。
...
Aesthetic Archive 面向需要建立、解释和复用视觉方向的人：

- **空间与景观设计师：** 前期研究、材料分析、空间参考、客户汇报和视觉方向。
- **平面与品牌设计师：** 视觉系统、编辑参考、字体、构图、色彩关系和品牌 Moodboard。
- **AI 视觉创作者：** 可重复的风格变量、双语 Prompt、负向约束和参考集合。
- **设计学生与新晋设计师：** 风格拆解、视觉研究和长期个人审美积累。
